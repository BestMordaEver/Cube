...
void Way::rotate_counter_clock(char choice) {
	rotate_clock(choice); rotate_clock(choice); rotate_clock(choice);
}

void Way::white_bottom(char q)
{
...
void Way::top_alg(char a, char b, char c)
{
	rotate_clock(a); rotate_clock(a); rotate_clock(a);
...
void Way::inv_alg(char a, char b, char c)
{
...
void Way::white_bottom_inverted(char q)
{
...
void Way::white_corners_alg_left()
{
...
void Way::white_corners_alg_right()
{
	rotate_clock('r');
	rotate_clock('y');
...
void Way::middle_place_left_alg(char left, char center)
{
	rotate_clock('y'); rotate_clock('y'); rotate_clock('y');
...
void Way::middle_place_right_alg(char center, char right)
{
	rotate_clock('y');
	rotate_clock(right);
	rotate_clock('y'); rotate_clock('y'); rotate_clock('y');
...
void Way::yellow_cross_algorithm()
{
	rotate_clock('r');
	rotate_clock('y');
	rotate_clock('g');
...
void Way::yellow_corners_algorithm()
{
	rotate_clock('g');
	rotate_clock('y');
	rotate_clock('g'); rotate_clock('g'); rotate_clock('g');
...
void Way::yellow_corner_orientation_algorithm()
{
	rotate_clock('g'); rotate_clock('g'); rotate_clock('g');
	rotate_clock('r');
	rotate_clock('g'); rotate_clock('g'); rotate_clock('g');
...
void Way::yellow_corner_orientation()
{
...
void Way::yellow_edges_colour_arrangement_right()
{
...
void Way::yellow_edges_colour_arrangement_left()
{
	rotate_clock('r'); rotate_clock('r');
	rotate_clock('y');
	rotate_clock('b');
...
void Way::yellow_edges_colour_arrangement()
{
	while (red[2] != 'r')
	{
		rotate_clock('r');
